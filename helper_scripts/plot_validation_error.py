...
ax2.set_ylabel(r'$\langle E_\mathbf{f}/\mathbf{f} \rangle$ [$\%$]', fontsize=10)
ax2.set_ylim(-5,0)

ax3 = fig.add_subplot(1,2,2)

ax3.hist(full_hist_z_err, bins=np.linspace(0,5,n_bins), color='k' , alpha=.8, normed=1 )
ax3.hist(min_draw_int_err, bins=np.linspace(0,5,n_bins), color='r' , alpha=.7, normed=1 )
...
ax3.set_xlabel(r'$\langle E \rangle$ [$\%$]', fontsize=10) 
ax3.set_ylabel(r'Cum. error $P_{E}$', fontsize=10) 

plt.subplots_adjust(left=0.15, right=0.98, bottom=0.2, hspace=0, wspace=0.5)
